...
script.addEventListener("Enable", function(){
  ...
  const FaceTask = Class(Object, {
    ...
    TEXTFORMAT_LIST: [
      ...
      TextFormat.YELLOW,
      TextFormat.WHITE,
      TextFormat.MINECOIN_GOLD || TextFormat.GOLD,
      TextFormat.MATERIAL_QUARTZ || TextFormat.YELLOW,
      TextFormat.MATERIAL_IRON || TextFormat.WHITE,
      TextFormat.MATERIAL_NETHERITE || TextFormat.DARK_GRAY,
      TextFormat.MATERIAL_REDSTONE || TextFormat.DARK_RED,
      TextFormat.MATERIAL_COPPER || TextFormat.GOLD,
      TextFormat.MATERIAL_GOLD || TextFormat.GOLD,
